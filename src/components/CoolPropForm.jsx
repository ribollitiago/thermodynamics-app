...
const CoolPropForm = ({ fluids, properties, fluidName, property1, property2, value1, value2, setFluidName, setProperty1, setProperty2, setValue1, setValue2, onCalculate }) => {
  return (
    <div>
      ...
      <div>
        ...
        <select value={property1} onChange={(e) => setProperty1(e.target.value)}>
      ...
      <div>
        ...
        <select value={property2} onChange={(e) => setProperty2(e.target.value)}>
          <option value="">Selecione uma propriedade</option>
          {properties.map((prop) => (
            <option key={prop} value={prop}>
              {prop}
